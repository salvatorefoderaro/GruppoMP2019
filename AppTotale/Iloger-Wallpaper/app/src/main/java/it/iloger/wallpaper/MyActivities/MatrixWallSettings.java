...
import static it.iloger.wallpaper.MyActivities.MatrixWallSettings.SettingsFragment.background_color;
import static it.iloger.wallpaper.MyActivities.MatrixWallSettings.SettingsFragment.text_color;

/**
 * Created by sapan on 1/12/2017.
 */

public class MatrixWallSettings extends AppCompatActivity implements colorDialog.ColorSelectedListener {
    ...
    public void onColorSelection(DialogFragment dialogFragment, @ColorInt int selectedColor) {
        ...
        switch (tag) {
            ...
            case 1:
                ...
                colorDialog.setPickerColor(MatrixWallSettings.this, 1, selectedColor);

                //set custom preference summary
                colorDialog.setColorPreferenceSummary(background_color, selectedColor, MatrixWallSettings.this, getResources());
            ...
            case 2:
                ...
                //Set the picker dialog's color
                colorDialog.setPickerColor(MatrixWallSettings.this, 2, selectedColor);

                //set custom preference summary
                colorDialog.setColorPreferenceSummary(text_color, selectedColor, MatrixWallSettings.this, getResources());
